...
"body{font-family:system-ui,-apple-system,sans-serif;background:linear-gradient(135deg,#0f0c29,#302b63,#24243e);min-height:100vh;padding:16px;color:#eee}"
"h1{text-align:center;font-size:22px;font-weight:700;margin-bottom:4px;background:linear-gradient(90deg,#a78bfa,#60a5fa,#34d399);-webkit-background-clip:text;-webkit-text-fill-color:transparent}"
".sub{text-align:center;font-size:11px;color:rgba(255,255,255,.35);margin-bottom:16px}"
".g{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:10px;max-width:900px;margin:0 auto}"
".c{background:rgba(255,255,255,.06);backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,.08);border-radius:14px;padding:14px 10px}"
".c h3{font-size:11px;color:rgba(255,255,255,.5);text-align:center;margin-bottom:10px;text-transform:uppercase;letter-spacing:1px}"
".b{display:block;width:100%;padding:9px 0;margin:3px 0;border:none;border-radius:8px;font-size:12px;font-weight:600;color:#fff;cursor:pointer;transition:transform .1s,opacity .15s}"
".b:active{transform:scale(.95);opacity:.7}"
...
".p{background:linear-gradient(135deg,#f59e0b,#d97706);box-shadow:0 2px 8px rgba(245,158,11,.2)}"
".row{display:flex;gap:4px}"
".row .b{flex:1}"
"#log{max-width:900px;margin:14px auto 0;background:rgba(0,0,0,.4);border:1px solid rgba(255,255,255,.06);border-radius:10px;padding:10px;max-height:160px;overflow-y:auto;font-family:'Courier New',monospace;font-size:11px;color:#4ade80;line-height:1.7}"
"#log .e{color:#f87171}"
"#log .t{color:rgba(255,255,255,.3)}"
"</style></head><body>"
"<h1>Smart Gateway</h1>"
"<p class=\"sub\">Curtain + AC + Lights</p>"
"<div class=\"g\">"
...
"<div class=\"row\"><button class=\"b o\" onclick=\"s(this,'/l/0/1')\">ALL ON</button>"
"<button class=\"b x\" onclick=\"s(this,'/l/0/0')\">ALL OFF</button></div>"
"<div class=\"row\"><button class=\"b p\" onclick=\"s(this,'/l/1/1')\">L1</button>"
"<button class=\"b p\" onclick=\"s(this,'/l/2/1')\">L2</button>"
"<button class=\"b p\" onclick=\"s(this,'/l/3/1')\">L3</button></div>"
"<div class=\"row\"><button class=\"b p\" onclick=\"s(this,'/l/4/1')\">L4</button>"
"<button class=\"b p\" onclick=\"s(this,'/l/5/1')\">L5</button>"
"<button class=\"b p\" onclick=\"s(this,'/l/6/1')\">L6</button></div></div>"
"</div>"
"<div id=\"log\"></div>"
"<script>"
